      ...
      <Link key={props.id} to={`/movies/${props.id}`}>
          ...
          <img
            src={
              props.poster_path
                ...
                : "https://images.unsplash.com/photo-1588546506381-74592e9b8a2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80"
            }
            alt=""
          />
        </div>
        ...
        <div className="info p-2 sm:text-xs md:text-base text-lg">
          <div className="flex justify-between">
            <p className="title text-white text-left" data-testid="movie-title">
              {props.title}
            </p>
          ...
          <div>
            <p
              className="release-date text-white p-1"
